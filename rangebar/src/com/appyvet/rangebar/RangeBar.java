...
public class RangeBar extends View {
    ...
    private boolean mDrawPinText = true;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mIsRangeBar) {
            ...
            mLeftThumb.init(ctx, yPos, expandedPinRadius, mPinColor, mTextColor, mCircleSize,
                    mCircleColor, mMinPinFont, mMaxPinFont, mArePinsTemporary, mDrawPinText);
        }
    ...
    private void rangeBarInit(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mDrawPinText = ta.getBoolean(R.styleable.RangeBar_drawPinText, true);
