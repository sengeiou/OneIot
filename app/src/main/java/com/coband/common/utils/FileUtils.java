...
//    }
    ...
    private FileUtils() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(sdcardState)) {
            ...
            BASE_PATH = App.getInstance().getCacheDir().getAbsolutePath();
        }
...
//    }
    ...
    public File getCacheDir() {
        return App.getInstance().getCacheDir().getAbsoluteFile();
    }

    //更改文件名(绝对路径)
    public void renameFile(String oldPath,String newFile){
