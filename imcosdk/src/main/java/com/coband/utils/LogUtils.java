...
public class LogUtils {
    ...
    public static void recordSleepData(String data) {
        File file = new File(Environment.getExternalStorageDirectory() + "/Kitfit_sleep_byte_data.txt");
        if (!file.exists()) {
            try {
                boolean createFileStatus = file.createNewFile();
                LogUtils.d("create file status >>>>>> " + createFileStatus);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public static void recordSportData(String data) {
        File file = new File(Environment.getExternalStorageDirectory() + "/kitfit_sport_byte_data.txt");
        if (!file.exists()) {
            try {
                boolean createFileStatus = file.createNewFile();
                LogUtils.d("create file status >>>>>> " + createFileStatus);
