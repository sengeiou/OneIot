...
public class BinInputStream extends BufferedInputStream {
    ...
    private void parseBinFileHeader() throws IOException {
        read(headBuf, 0, headerSize);
        ByteBuffer headerBuf = ByteBuffer.wrap(headBuf, 0, headerSize);
    ...
    public int readPacket(byte[] buffer, int len) throws IOException {
        int i = 0;
