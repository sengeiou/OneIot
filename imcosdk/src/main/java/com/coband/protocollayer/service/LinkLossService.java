...
public class LinkLossService {
    ...
    private void initial() {
        ...
        LogUtils.d(TAG, ">>> LinkLossService initial");
    ...
    public boolean readInfo() {
        ...
        return mGlobalGatt.readCharacteristic(mAlertLevelCharac);
    }
    ...
    public boolean enableAlert(boolean enable) {
        ...
        return mGlobalGatt.writeCharacteristicSync(mAlertLevelCharac);
    }
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (mService == null) {
                    ...
                    if (mAlertLevelCharac == null) {
                        ...
                        if (D)
                            Log.d(TAG, "Link Loss service is found, mAlertLevelCharac: " + mAlertLevelCharac.getUuid());
                    }
                }
                //isConnected = true;
            } else {
