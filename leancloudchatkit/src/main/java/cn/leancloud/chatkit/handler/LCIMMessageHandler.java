            ...
            if (!client.getClientId().equals(LCChatKit.getInstance().getCurrentUserId())) {
                ...
                if (!message.getFrom().equals(client.getClientId())) {
                    if (LCIMNotificationUtils.isShowNotification(conversation.getConversationId())) {
                        ...
                        if (null != muteList && muteList.contains(conversation.getConversationId())) {
                        } else {
                    ...
                    LCIMProfileCache.getInstance().cacheUser(new LCChatKitUser(message.getFrom(), typeBean._lcattrs.userName, typeBean._lcattrs.userAvatarUrl));
