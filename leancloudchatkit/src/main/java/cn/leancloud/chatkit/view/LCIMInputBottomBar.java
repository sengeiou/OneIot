 ...
 */
public class LCIMInputBottomBar extends LinearLayout implements EmoticonsFuncView.OnEmoticonsPageViewListener {
...
//  private View moreLayout2;
    ...
    private void initView(Context context) {
        ...
        emojiBtn = findViewById(R.id.input_bar_btn_emoji);
        contentEditText = (EmoticonsEditText) findViewById(R.id.input_bar_et_content);
        ...
        mEmoticonsFuncView = (EmoticonsFuncView) findViewById(R.id.view_etv);
