 ...
 * 录音的按钮
 */
public class LCIMRecordButton extends android.support.v7.widget.AppCompatButton {
  private static final String TAG = "LCIMRecordButton";
    ...
    public void run() {
      while (running) {
        ...
        if (recorder == null || !running) {
          Log.d(TAG, "recorder == null || !running  >>>>>>");
          break;
        }
