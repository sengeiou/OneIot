...
import cn.leancloud.chatkit.MessageTypeBean;
...
public class LCIMChatItemHolder extends LCIMCommonViewHolder {
  private final static String TAG = "LCIMChatItemHolder";
  ...
  public void initView() {
    if (isLeft) {
      avatarView = (CircleImageView) itemView.findViewById(R.id.chat_left_iv_avatar);
      ...
      avatarView = (CircleImageView) itemView.findViewById(R.id.chat_right_iv_avatar);
...
//    MessageTypeBean typeBean = new Gson().fromJson(message.getContent(), MessageTypeBean.class);
//      Glide.with(getContext()).load(typeBean._lcattrs.userAvatarUrl)
      ...
      protected void internalDone0(LCChatKitUser userProfile, AVException e) {
        ...
        if (null != e) {
          ...
          if (!TextUtils.isEmpty(avatarUrl)) {
            Glide.with(getContext()).load(avatarUrl).centerCrop().fitCenter()
